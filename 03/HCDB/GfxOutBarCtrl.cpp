...
void CGfxOutBarCtrl::OnLButtonDown(UINT nFlags, CPoint point) 
{
	...
	int index=-1, ht = HitTestEx(point, index);
...
*/
	...
	if(iSelFolder==1)
	{
		if(index==0)
			///////////////////////////////////////////////////////////////////	
		{
			CMQQAppearanceDlg *cqq=(CMQQAppearanceDlg *)GetParent();
			CSplitterWnd *cframe=(CSplitterWnd *)cqq->GetParent();
			CAnotherView *cwnd=(CAnotherView *)cframe->GetPane(0,1);
